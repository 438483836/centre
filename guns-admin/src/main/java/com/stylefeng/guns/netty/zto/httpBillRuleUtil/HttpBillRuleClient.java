...
public class HttpBillRuleClient {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HttpBillRuleClient.class);
    ...
    public static void main(String[] args) throws Exception {
        HttpBillRuleClient client = new HttpBillRuleClient();
        client.start();
        client.sendImpl(HttpRequestFormat.billRule());
    }
}
