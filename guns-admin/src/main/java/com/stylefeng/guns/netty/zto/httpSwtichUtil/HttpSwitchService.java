...
@Service
public class HttpSwitchService implements ApplicationContextAware {

    private static ApplicationContext applicationContext;

    public static final LinkedBlockingQueue<String> linkedBlockingQueue = new LinkedBlockingQueue<String>();

    private static final Logger logger = LoggerFactory.getLogger(HttpSwitchService.class);
    ...
    private void startService() {
        ...
        thread.start();
        logger.info("HttpSwitchService startService success-------------->");
    }
}
