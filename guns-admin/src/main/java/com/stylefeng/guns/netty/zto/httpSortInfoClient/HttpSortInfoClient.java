...
*/
public class HttpSortInfoClient {

    private static final Logger logger = LoggerFactory.getLogger(HttpSortInfoClient.class);
    ...
    public void start() {
        ...
        bootstrap.handler(new ChannelInitializer<SocketChannel>() {
            ...
            public void initChannel(SocketChannel ch) throws Exception {
                ...
                ch.pipeline().addLast(new HttpSortInfoClientHandler());
            }
        });
    ...
    public void sendImpl(String msg){
        ...
        channelFuture.channel().writeAndFlush(request).addListener((ChannelFutureListener) future -> {
            if (future.isSuccess()){
                logger.info("send sort-info request to zto success. msg:[{}]",msg);
            }else {
                logger.info("send sort-info request to zto fail. msg:[{}]",msg);
            }
        });
        try {
    ...
    public static void main(String[] args) throws Exception {
        HttpSortInfoClient client = new HttpSortInfoClient();
        client.start();
